...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 -translate-x-1/2 h-[5.5rem] w-full rounded-none bg-gray-50 bg-opacity-85 shadow-lg shadow-black/[0.1] backdrop-blur-[10rem] sm:top-6 sm:h-[3.25rem] sm:w-[35rem] sm:rounded-full "

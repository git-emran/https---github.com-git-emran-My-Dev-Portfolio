  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-2 border-slate-200 px-8 py-6 md:w-[450px]"
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <div className="pt-4">
                    <Image src={item.imageUrl} alt="" height="52" width="52" className="rounded-full" />
                  </div>

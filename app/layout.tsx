...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-custom-bg bg-white bg-transparent bg-cover bg-center w-full overflow-x-hidden text-gray-950 relative dark:text-opacity-90`}
      >
